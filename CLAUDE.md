...
**YOU ARE IN: `gasket/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gasket/` (rig root) or other directories
...
**Your mail address:** `gasket/polecats/furiosa`
**Your rig:** gasket
**Your Witness:** `gasket/witness`
...
| Ask Witness for help | `gt mail send gasket/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gasket/witness`) when:
...
```bash
gt mail send gasket/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
